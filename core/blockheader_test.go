...
var mainNetGenesisHash = utils.Hash([utils.Hash256Size]byte{ // Make go vet happy.
...
var mainNetGenesisMerkleRoot = utils.Hash([utils.Hash256Size]byte{ // Make go vet happy.
...
var firstBlockHash = utils.Hash([utils.Hash256Size]byte{
