...
var GenesisCoinbaseTx = core.Tx{}

var GenesisHash = utils.Hash([utils.Hash256Size]byte{
...
var GenesisMerkleRoot = utils.Hash([utils.Hash256Size]byte{
...
var GenesisBlock = BlockMessage{
	Block: &core.Block{
		BlockHeader: core.BlockHeader{
			...
			HashMerkleRoot: crypto.HexToHash("4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"),
			Time:           uint32(time.Unix(0x495fab29, 0).Nanosecond()), //2009-01-03 18:15:05 +0000 UTC
			Bits:           0x1d00ffff,                                    //486604799  [00000000ffff0000000000000000000000000000000000000000000000000000]
			Nonce:          0x7c2bac1d,                                    // 2083236893
		},
		Transactions: []*core.Tx{&GenesisCoinbaseTx},
	},
}
var RegressionTestGenesisHash = utils.Hash([utils.Hash256Size]byte{
...
var TestNet3GenesisHash = utils.Hash([utils.Hash256Size]byte{
...
var SimNetGenesisHash = utils.Hash([utils.Hash256Size]byte{
