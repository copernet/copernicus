...
func (h *BlockHeader) BlockHash() util.Hash {
...
func (h *BlockHeader) Encode(w io.Writer, pver uint32, enc MessageEncoding) error {
...
func NewBlockHeader(version int32, prevHash, merkleRootHash *util.Hash,
...
func readBlockHeader(r io.Reader, pver uint32, bh *BlockHeader) error {
	return util.ReadElements(r, &bh.Version, &bh.PrevBlock, &bh.MerkleRoot,
...
func writeBlockHeader(w io.Writer, pver uint32, bh *BlockHeader) error {
	return util.WriteElements(w, bh.Version, &bh.PrevBlock, &bh.MerkleRoot,
		bh.Timestamp, bh.Bits, bh.Nonce)
}
