...
// interface.
func (msg *fakeMessage) Decode(r io.Reader, pver uint32, enc MessageEncoding) error {
	return nil
}
...
func (msg *fakeMessage) Encode(w io.Writer, pver uint32, enc MessageEncoding) error {
