...
func TestFeeFilterLatest(t *testing.T) {
	...
	err := msg.Encode(&buf, pver, BaseEncoding)
	if err != nil {
	...
	err = readmsg.Decode(&buf, pver, BaseEncoding)
	if err != nil {
...
func TestFeeFilterWire(t *testing.T) {
	...
	for i, test := range tests {
		...
		var buf bytes.Buffer
		err := test.in.Encode(&buf, test.pver, BaseEncoding)
		if err != nil {
		...
		err = msg.Decode(rbuf, test.pver, BaseEncoding)
		if err != nil {
...
func TestFeeFilterWireErrors(t *testing.T) {
	...
	for i, test := range tests {
		...
		err := test.in.Encode(w, test.pver, BaseEncoding)
		...
		err = msg.Decode(r, test.pver, BaseEncoding)
