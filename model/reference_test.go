...
var scriptErrorDesc = map[string]core.ScriptError{
	"OK":                                    core.SCRIPT_ERR_OK,
	"UNKNOWN_ERROR":                         core.SCRIPT_ERR_UNKNOWN_ERROR,
	"OP_RETURN":                             core.SCRIPT_ERR_OP_RETURN,
	"SCRIPT_SIZE":                           core.SCRIPT_ERR_SCRIPT_SIZE,
	"PUSH_SIZE":                             core.SCRIPT_ERR_PUSH_SIZE,
	"OP_COUNT":                              core.SCRIPT_ERR_OP_COUNT,
	"STACK_SIZE":                            core.SCRIPT_ERR_STACK_SIZE,
	"SIG_COUNT":                             core.SCRIPT_ERR_SIG_COUNT,
	"PUBKEY_COUNT":                          core.SCRIPT_ERR_PUBKEY_COUNT,
	"VERIFY":                                core.SCRIPT_ERR_VERIFY,
	"EQUALVERIFY":                           core.SCRIPT_ERR_EQUALVERIFY,
	"CHECKMULTISIGVERIFY":                   core.SCRIPT_ERR_CHECKMULTISIGVERIFY,
	"CHECKSIGVERIFY":                        core.SCRIPT_ERR_CHECKSIGVERIFY,
	"NUMEQUALVERIFY":                        core.SCRIPT_ERR_NUMEQUALVERIFY,
	"BAD_OPCODE":                            core.SCRIPT_ERR_BAD_OPCODE,
	"DISABLED_OPCODE":                       core.SCRIPT_ERR_DISABLED_OPCODE,
	"INVALID_STACK_OPERATION":               core.SCRIPT_ERR_INVALID_STACK_OPERATION,
	"INVALID_ALTSTACK_OPERATION":            core.SCRIPT_ERR_INVALID_ALTSTACK_OPERATION,
	"UNBALANCED_CONDITIONAL":                core.SCRIPT_ERR_UNBALANCED_CONDITIONAL,
	"NEGATIVE_LOCKTIME":                     core.SCRIPT_ERR_NEGATIVE_LOCKTIME,
	"UNSATISFIED_LOCKTIME":                  core.SCRIPT_ERR_UNSATISFIED_LOCKTIME,
	"SIG_HASHTYPE":                          core.SCRIPT_ERR_SIG_HASHTYPE,
	"SIG_DER":                               core.SCRIPT_ERR_SIG_DER,
	"MINIMALDATA":                           core.SCRIPT_ERR_MINIMALDATA,
	"SIG_PUSHONLY":                          core.SCRIPT_ERR_SIG_PUSHONLY,
	"SIG_HIGH_S":                            core.SCRIPT_ERR_SIG_HIGH_S,
	"SIG_NULLDUMMY":                         core.SCRIPT_ERR_SIG_NULLDUMMY,
	"PUBKEYTYPE":                            core.SCRIPT_ERR_PUBKEYTYPE,
	"CLEANSTACK":                            core.SCRIPT_ERR_CLEANSTACK,
	"MINIMALIF":                             core.SCRIPT_ERR_MINIMALIF,
	"NULLFAIL":                              core.SCRIPT_ERR_SIG_NULLFAIL,
	"DISCOURAGE_UPGRADABLE_NOPS":            core.SCRIPT_ERR_DISCOURAGE_UPGRADABLE_NOPS,
	"DISCOURAGE_UPGRADABLE_WITNESS_PROGRAM": core.SCRIPT_ERR_DISCOURAGE_UPGRADABLE_WITNESS_PROGRAM,
	"WITNESS_PROGRAM_WRONG_LENGTH":          core.SCRIPT_ERR_WITNESS_PROGRAM_WRONG_LENGTH,
	"WITNESS_PROGRAM_WITNESS_EMPTY":         core.SCRIPT_ERR_WITNESS_PROGRAM_WITNESS_EMPTY,
	"WITNESS_PROGRAM_MISMATCH":              core.SCRIPT_ERR_WITNESS_PROGRAM_MISMATCH,
	"WITNESS_MALLEATED":                     core.SCRIPT_ERR_WITNESS_MALLEATED,
	"WITNESS_MALLEATED_P2SH":                core.SCRIPT_ERR_WITNESS_MALLEATED_P2SH,
	"WITNESS_UNEXPECTED":                    core.SCRIPT_ERR_WITNESS_UNEXPECTED,
	"WITNESS_PUBKEYTYPE":                    core.SCRIPT_ERR_WITNESS_PUBKEYTYPE,
}

var mapFlagNames = map[string]uint32{
	"NONE":                                  core.SCRIPT_VERIFY_NONE,
	"P2SH":                                  core.SCRIPT_VERIFY_P2SH,
	"STRICTENC":                             core.SCRIPT_VERIFY_STRICTENC,
	"DERSIG":                                core.SCRIPT_VERIFY_DERSIG,
	"LOW_S":                                 core.SCRIPT_VERIFY_LOW_S,
	"SIGPUSHONLY":                           core.SCRIPT_VERIFY_SIGPUSHONLY,
	"MINIMALDATA":                           core.SCRIPT_VERIFY_MINIMALDATA,
	"NULLDUMMY":                             core.SCRIPT_VERIFY_NULLDUMMY,
	"DISCOURAGE_UPGRADABLE_NOPS":            core.SCRIPT_VERIFY_DISCOURAGE_UPGRADABLE_NOPS,
	"CLEANSTACK":                            core.SCRIPT_VERIFY_CLEANSTACK,
	"MINIMALIF":                             core.SCRIPT_VERIFY_MINIMALIF,
	"NULLFAIL":                              core.SCRIPT_VERIFY_NULLFAIL,
	"CHECKLOCKTIMEVERIFY":                   core.SCRIPT_VERIFY_CHECKLOCKTIMEVERIFY,
	"CHECKSEQUENCEVERIFY":                   core.SCRIPT_VERIFY_CHECKSEQUENCEVERIFY,
	"DISCOURAGE_UPGRADABLE_WITNESS_PROGRAM": core.SCRIPT_VERIFY_DISCOURAGE_UPGRADABLE_WITNESS_PROGRAM,
	"COMPRESSED_PUBKEYTYPE":                 core.SCRIPT_VERIFY_COMPRESSED_PUBKEYTYPE,
	"SIGHASH_FORKID":                        core.SCRIPT_ENABLE_SIGHASH_FORKID,
}
...
// not supported.
func parseExpectedResult(expected string) core.ScriptError {
