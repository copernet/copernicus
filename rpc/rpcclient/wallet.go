...
//func (c *Client) GetTransactionAsync(txHash *utils.Hash) FutureGetTransactionResult {
//	hash := ""
//	if txHash != nil {
...
//func (c *Client) GetTransaction(txHash *utils.Hash) (*btcjson.GetTransactionResult, error) {
...
//func (c *Client) ListSinceBlockAsync(blockHash *utils.Hash) FutureListSinceBlockResult {
//	var hash *string
//	if blockHash != nil {
//		hash = btcjson.String(blockHash.ToString())
//	}
//
...
//func (c *Client) ListSinceBlock(blockHash *utils.Hash) (*btcjson.ListSinceBlockResult, error) {
...
//func (c *Client) ListSinceBlockMinConfAsync(blockHash *utils.Hash, minConfirms int) FutureListSinceBlockResult {
//	var hash *string
//	if blockHash != nil {
//		hash = btcjson.String(blockHash.ToString())
//	}
...
//func (c *Client) ListSinceBlockMinConf(blockHash *utils.Hash, minConfirms int) (*btcjson.ListSinceBlockResult, error) {
...
//		sha, err := utils.GetHashFromStr(input.Txid)
//		if err != nil {
//			return nil, err
//		}
...
//func (r FutureSendToAddressResult) Receive() (*utils.Hash, error) {
//	res, err := receiveFuture(r)
//	if err != nil {
//		return nil, err
//	}
...
//	}
//
//	return utils.GetHashFromStr(txHash)
//}
//
...
//func (c *Client) SendToAddress(address btcutil.Address, amount btcutil.Amount) (*utils.Hash, error) {
...
//// NOTE: This function requires to the wallet to be unlocked.  See the
//// WalletPassphrase function for more details.
//func (c *Client) SendToAddressComment(address btcutil.Address, amount btcutil.Amount, comment, commentTo string) (*utils.Hash, error) {
...
//func (r FutureSendFromResult) Receive() (*utils.Hash, error) {
//	res, err := receiveFuture(r)
//	if err != nil {
//		return nil, err
//	}
...
//// NOTE: This function requires to the wallet to be unlocked.  See the
//// WalletPassphrase function for more details.
//func (c *Client) SendFrom(fromAccount string, toAddress btcutil.Address, amount btcutil.Amount) (*utils.Hash, error) {
...
//// NOTE: This function requires to the wallet to be unlocked.  See the
//// WalletPassphrase function for more details.
//func (c *Client) SendFromMinConf(fromAccount string, toAddress btcutil.Address, amount btcutil.Amount, minConfirms int) (*utils.Hash, error) {
...
//	comment, commentTo string) (*utils.Hash, error) {
//
...
//func (r FutureSendManyResult) Receive() (*utils.Hash, error) {
//	res, err := receiveFuture(r)
//	if err != nil {
//		return nil, err
//	}
...
//// NOTE: This function requires to the wallet to be unlocked.  See the
//// WalletPassphrase function for more details.
//func (c *Client) SendMany(fromAccount string, amounts map[btcutil.Address]btcutil.Amount) (*utils.Hash, error) {
...
//	amounts map[btcutil.Address]btcutil.Amount,
//	minConfirms int) (*utils.Hash, error) {
//
...
//	amounts map[btcutil.Address]btcutil.Amount, minConfirms int,
//	comment string) (*utils.Hash, error) {
//
