...
var helpDescsEnUS = map[string]string{
	...
	"debuglevel--synopsis": "Dynamically changes the debug logging level.\n" +
		...
		"The valid subsystems are AMGR, ADXR, BCDB, BMGR, copernicus, CHAN, DISC, PEER, RPCS, SCRP, SRVR, and TXMP.\n" +
	...
	"getblock-verbosetx":   "Specifies that each transaction is returned as a JSON object and only applies if the verbose flag is true (copernicus extension)",
	...
	"sendrawtransaction-allowhighfees": "Whether or not to allow insanely high fees (copernicus does not yet implement this parameter, so it has no effect)",
	"sendrawtransaction--result0":      "The hash of the transaction",

	// StopCmd help.
	"stop--synopsis": "Shutdown copernicus.",
	"stop--result0":  "The string 'copernicus stopping.'",
