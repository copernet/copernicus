...
var GenesisHash = utils.Hash([utils.HASH_SIZE]byte{
...
var GenesisMerkleRoot = utils.Hash([utils.HASH_SIZE]byte{
...
var RegressionTestGenesisHash = utils.Hash([utils.HASH_SIZE]byte{
...
var TestNet3GenesisHash = utils.Hash([utils.HASH_SIZE]byte{
...
var SimNetGenesisHash = utils.Hash([utils.HASH_SIZE]byte{
