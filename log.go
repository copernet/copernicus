...
var (
	...
	mempoolLog = backendLog.Logger("POOL")
	connLog    = backendLog.Logger("CONN")
	msgLog     = backendLog.Logger("MESS")
	netLog     = backendLog.Logger("NETW")
	p2pLog     = backendLog.Logger("P2PL")
...
func init() {
	...
	core.UseLogger(coreLog)
	mempool.UseLogger(mempoolLog)
	conn.UseLogger(connLog)
	msg.UseLogger(msgLog)
