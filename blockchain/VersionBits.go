...
func (w *WarningBitsConditionChecker) Condition(index *BlockIndex, params *msg.BitcoinParams) bool {

	return index.Version&VERSIONBITS_TOP_MASK == VERSIONBITS_TOP_BITS &&
